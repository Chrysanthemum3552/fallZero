...
## 1. 업데이트 현황
### 2026-06-01 (송민석) - 운동 안내 영상 제작 및 자막 출력 형식 개선
- 영상에 자막 삽입이 아닌 코드로 자막을 추가해 화면 크기에 맞게 자막 출력
- **안내 영상 8종 제작** — 앉아서 무릎 펴기 / 옆으로 다리 들기 / 뒤로 무릎 굽히기 / 발뒤꿈치 들기 / 발끝 들기 / 무릎 살짝 굽히기 / 의자에서 일어서기 / 한 발로 서서 균형 잡기 완료
...
### 2026-05-14 (송민석) — UI/UX 개선 + 검사 세션 안내 영상 제작
